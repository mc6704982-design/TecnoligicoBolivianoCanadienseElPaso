...
const typed = new Typed('#prompts-sample', {
    strings: ["Refuerza tus conocimientos con simulaciones reales.", 
                "Aprende a tu ritmo, donde quieras y cuando quieras.", 
                "Accede a contenidos actualizados en Electricidad Industrial.", 
                "Practica sin riesgos y domina la seguridad eléctrica."],
    typeSpeed: 80,
    smartBackspace: true, 
    loop: true,
    backDelay: 2000,
